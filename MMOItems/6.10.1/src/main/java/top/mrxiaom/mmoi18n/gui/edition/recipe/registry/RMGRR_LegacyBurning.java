package top.mrxiaom.mmoi18n.gui.edition.recipe.registry;
...
import top.mrxiaom.mmoi18n.gui.edition.recipe.button.RBA_AmountOutput;
...
import top.mrxiaom.mmoi18n.gui.edition.recipe.gui.RMG_BurningLegacy;
import top.mrxiaom.mmoi18n.gui.edition.recipe.gui.RecipeEditorGUI;
import top.mrxiaom.mmoi18n.gui.edition.recipe.registry.burninglegacy.BurningRecipeInformation;
import top.mrxiaom.mmoi18n.gui.edition.recipe.registry.burninglegacy.CraftingType;
...
public class RMGRR_LegacyBurning implements RecipeRegistry {
    ...
    @Override public void openForPlayer(@NotNull EditionInventory inv, @NotNull String recipeName, Object... otherParams) { new RMG_BurningLegacy(inv.getNavigator(), inv.getEdited(), recipeName, this).open(inv); }
