...
public class CraftingStationPreview extends PluginInventory implements InjectedInventory {
	private final net.Indyuce.mmoitems.gui.CraftingStationView previous;
	...
	public CraftingStationPreview(net.Indyuce.mmoitems.gui.CraftingStationView previous, CheckedRecipe recipe) {
	...
	public void whenClicked(InventoryClickEvent event) {
		...
		if (!MMOUtils.isMetaItem(event.getCurrentItem(), false)) return;
